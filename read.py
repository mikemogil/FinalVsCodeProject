...
for files in filePath:
        allFiles.append(os.path.basename(files))
print(allFiles)
# tree = ET.parse(r'X:\PROGRAMMING\CUSTOMER\NUVASIVE\RELINE CERVICAL CROSS CONNECTS\1889082_revA\CURRENT\VERICUT\RD_10-20-22_1889082_REVA-BIGCLAMPER-Op1.tls')
...
#     WHERE p.PartNum = '1889082'And pm.RevisionNum = 'A' AND p2.partnum IN :idlist
#     ORDER BY pm.MtlSeq
#     """
# )
...
#         rowsPart = [('1889082', part[0], part[1], part[2], start_sequence_number + i * increment, revNum)for i, part in enumerate(rowsPart)]

#         startSeq = rowsPart[-1]
#         updated_part_new = [('1889082',part[0], part[1], 0.01, startSeq[4] + i * increment, revNum) for i,part in enumerate(partNew)]
