...
# headers = ["MtlPartNum", "PartDescription", "QtyPer", "MtlSeq"]
# for col_num, header in enumerate(headers, start=1):
#     col_letter = get_column_letter(col_num)
#     sheet[f"{col_letter}1"] = header

# # Adding data to the sheet
# row_num = 2  # Start adding data from row 2
# for row in rowsPart:
...
# # Saving the workbook to a file on the desktop
